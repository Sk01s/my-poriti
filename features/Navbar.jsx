...
const Navbar = () => {
  return (
    <header className="flex flex-col-reverse justify-between items-stretch shadow-2xl rounded-3xl px-3 fixed z-10 bg-black top-[22%] w-[85px] h-[53%] right-[0.5%] sm:top-2 sm:left-[0.5%] sm:w-[99%] sm:flex-row sm:h-20">
      <Link href="/">
        <a
